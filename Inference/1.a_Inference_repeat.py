...
def generate_follow_up(question, answer):
    try:
        ...
        # elif mode == 'beam':
        # beamsearch sampling
        outputs = model.generate(**inputs, max_length=1024, num_return_sequences=10, num_beams=20, num_beam_groups=10, diversity_penalty=10.0, early_stopping=True, do_sample=True, temperature=1.0)
...
for model_version in ["org", "full", 'gpt']: # "org", "small", "full", 'gpt'
  result_filename = model_version + f"_result.json"
  ...
  # for i in range(5):
    ...
    generated_follow_up = generate_follow_up(q, a)
